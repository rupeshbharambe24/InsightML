...
class TestToPandas:
    ...
    def test_is_polars_available_returns_bool(self):
        from insightml._compat import is_polars_available

        result = is_polars_available()
        assert isinstance(result, bool)

    def test_get_pandas_version_returns_tuple(self):
        from insightml._compat import get_pandas_version
...
class TestLoadTitanic:
    def test_returns_dataframe(self):
        from insightml.datasets import load_titanic
...
class TestLoadHousing:
    def test_returns_dataframe(self):
        from insightml.datasets import load_housing
